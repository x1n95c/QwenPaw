...
- **Гибкость**: большинство вопросов решается чтением доков, исходников и конфигурации. Пробуйте разные способы: например, если нет `~/.qwenpaw`, потому что каталог данных изменён, ищите рабочую область иначе.
