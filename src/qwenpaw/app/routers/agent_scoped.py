...
def create_agent_scoped_router() -> APIRouter:
    ...
    from ..cron_templates.api import (
        batch_script_router as template_batch_router,
    )
    ...
    # /agents/{agentId}/cron/* -> cron_router (+ cron_batches_router)
    # /agents/{agentId}/cron-skills -> cron_skills_router
    # /agents/{agentId}/cron-templates/* -> cron_template_router
    # /agents/{agentId}/cron-template-batches -> template_batch_router
